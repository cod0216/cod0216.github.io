...
- 대부분 데이터를 전송할 때 아래 그림처럼 인터넷을 이용한다.
    ...
    ![스크린샷 2026-01-25 오전 12.48.59.png](attachment:a914687e-8e5b-432a-958b-94712b57e59f:스크린샷_2026-01-25_오전_12.48.59.png)
...
- 이런 경우 아래 그림처럼 서버(TURN)를 하나 두고 거기를 터널처럼 이용하는 방법이 있다.
    ...
    ![스크린샷 2026-01-25 오전 1.04.32.png](attachment:6f293e79-173f-4aa7-a980-cd5396a29c2a:스크린샷_2026-01-25_오전_1.04.32.png)
